    ...
    <>
      <Container className="privacy-page border border-dark  mb-5 mt-5">
        ...
        <p>At Concert Crawl, accessible from https://www.concertcrawl.com, one of our main priorities is the privacy
          ...
          by Concert Crawl and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards to the information that they shared and/or collect in Concert Crawl. This policy is not applicable
          ...
          the <a href="https://www.generateprivacypolicy.com">Generate Privacy Policy Generator</a>.</p>
        ...
        <p>Concert Crawl follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, Concert Crawl uses 'cookies'. These cookies are used to store information including
        ...
        <p>Concert Crawl does not knowingly collect any Personal Identifiable Information from children under the age
